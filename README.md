...
* [ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 27,478 | 🐛 210 | 🌐 Python | 📅 2026-05-15 - A tool which maintains an additive archive from RSS feeds, bookmarks, and links using wget, Chrome headless, and other methods (formerly `Bookmark Archiver`). *(In Development)*
* [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 21,114 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-24 - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file. *(Stable)*
* [monolith](https://github.com/Y2Z/monolith) ⭐ 15,085 | 🐛 68 | 🌐 Rust | 📅 2026-05-01 - CLI tool to save a web page as a single HTML file. *(Stable)*
...
* [Heritrix](https://github.com/internetarchive/heritrix3/wiki) ⭐ 3,225 | 🐛 34 | 🌐 Java | 📅 2026-05-12 - An open source, extensible, web-scale, archival quality web crawler. *(Stable)*
  * [Heritrix Q\&A](https://github.com/internetarchive/heritrix3/discussions/categories/q-a) ⭐ 3,225 | 🐛 34 | 🌐 Java | 📅 2026-05-12 - A discussion forum for asking questions and getting answers about using Heritrix.
  * [Heritrix Walkthrough](https://github.com/web-archive-group/heritrix-walkthrough) ⭐ 10 | 🐛 2 | 🌐 Shell | 📅 2016-06-10 *(In Development)*
* [Wayback](https://github.com/wabarc/wayback) ⭐ 2,187 | 🐛 70 | 🌐 Go | 📅 2026-05-14 - A toolkit for snapshot webpage to Internet Archive, archive.today, IPFS and beyond. *(Stable)*
* [grab-site](https://github.com/ArchiveTeam/grab-site) ⭐ 1,569 | 🐛 103 | 🌐 Python | 📅 2025-05-23 - The archivist's web crawler: WARC output, dashboard for all crawls, dynamic ignore patterns. *(Stable)*
...
* [Auto Archiver](https://github.com/bellingcat/auto-archiver) ⭐ 1,079 | 🐛 17 | 🌐 Python | 📅 2026-05-13 - Python script to automatically archive social media posts, videos, and images from a Google Sheets document. Read the [article about Auto Archiver on bellingcat.com](https://www.bellingcat.com/resources/2022/09/22/preserve-vital-online-content-with-bellingcats-auto-archiver-tool/).
* [Browsertrix Crawler](https://github.com/webrecorder/browsertrix-crawler) ⭐ 1,036 | 🐛 136 | 🌐 TypeScript | 📅 2026-05-13 - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container. *(Stable)*
* [Brozzler](https://github.com/internetarchive/brozzler) ⭐ 796 | 🐛 60 | 🌐 Python | 📅 2026-05-12 - A distributed web crawler (爬虫) that uses a real browser (Chrome or Chromium) to fetch pages and embedded urls and to extract links. *(Stable)*
...
* [Waybackpy](https://github.com/akamhy/waybackpy) ⭐ 579 | 🐛 20 | 🌐 Python | 📅 2024-02-26 -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool  *(Stable)*
* [Warcprox](https://github.com/internetarchive/warcprox) ⭐ 450 | 🐛 26 | 🌐 Python | 📅 2026-05-11 - WARC-writing MITM HTTP/S proxy. *(Stable)*
...
* [Scoop](https://github.com/harvard-lil/scoop) ⭐ 197 | 🐛 14 | 🌐 JavaScript | 📅 2025-09-03 - High-fidelity, browser-based, single-page web archiving library and CLI for witnessing the web. *(Stable)*
...
* [Cairn](https://github.com/wabarc/cairn) ⭐ 51 | 🐛 30 | 🌐 TypeScript | 📅 2026-05-13 - A npm package and CLI tool for saving webpages. *(Stable)*
...
* [PYWB](https://github.com/webrecorder/pywb) ⭐ 1,657 | 🐛 180 | 🌐 JavaScript | 📅 2026-04-10 - A Python 3 implementation of web archival replay tools, sometimes also known as 'Wayback Machine'. *(Stable)*
...
* [hyphe](https://github.com/medialab/hyphe) ⭐ 379 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-21 - A webcrawler built for research uses with a graphical user interface in order to build web corpuses made of lists of web actors and maps of links between them. *(Stable)*
...
* [PANDORÆ](https://github.com/Guillaume-Levrier/PANDORAE) ⭐ 16 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-04 - A desktop research software to be plugged on a Solr endpoint to query, retrieve, normalize and visually explore web archives. *(Stable)*
...
* [gowarcserver](https://github.com/nlnwa/gowarcserver) ⭐ 17 | 🐛 10 | 🌐 Go | 📅 2025-03-31 - [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,612 | 🐛 44 | 🌐 Go | 📅 2026-05-08-based capture index (CDX) and WARC record server, used to index and serve WARC files (Go).
* [duckdb\_warc](https://github.com/midwork-finds-jobs/duckdb_warc) ⭐ 4 | 🐛 1 | 🌐 Rust | 📅 2026-02-05 - DuckDB extension to query WARC files. *(In Development)*
...
* [Internet Archive Library](https://github.com/jjjake/internetarchive) ⭐ 1,860 | 🐛 100 | 🌐 Python | 📅 2026-05-14 - A command line tool and Python library for interacting directly with <!--lint ignore double-link-->[archive.org](https://archive.org). (Python). *(Stable)*
* [wikiteam](https://github.com/WikiTeam/wikiteam) ⭐ 841 | 🐛 172 | 🌐 Python | 📅 2026-01-10 - Tools for downloading and preserving wikis. *(Stable)*
...
* [warcio](https://github.com/webrecorder/warcio) ⭐ 456 | 🐛 60 | 🌐 Python | 📅 2026-04-06 - Streaming WARC/ARC library for fast web archive IO (Python). *(Stable)*
...
* [FastWARC](https://github.com/chatnoir-eu/chatnoir-resiliparse) ⭐ 138 | 🐛 0 | 🌐 Rust | 📅 2026-05-14 - A high-performance WARC parsing library (Python).
* [node-warc](https://github.com/N0taN3rd/node-warc) ⭐ 104 | 🐛 23 | 🌐 JavaScript | 📅 2025-01-29 - Parse WARC files or create WARC files using either [Electron](https://electron.atom.io/) or [chrome-remote-interface](https://github.com/cyrus-and/chrome-remote-interface) ⭐ 4,525 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 (Node.js). *(Stable)*
* [warc](https://github.com/jedireza/warc) ⭐ 59 | 🐛 10 | 🌐 Rust | 📅 2024-11-27 - A Rust library for reading and writing WARC files. *(Stable)*
* [jwarc](https://github.com/iipc/jwarc) ⭐ 58 | 🐛 18 | 🌐 Java | 📅 2026-04-27 - Read and write WARC files with a type safe API (Java).
...
* [ArchiveSpark](https://github.com/helgeho/ArchiveSpark) ⭐ 159 | 🐛 5 | 🌐 Scala | 📅 2025-10-08 - An Apache Spark framework (not only) for Web Archives that enables easy data processing, extraction as well as derivation. *(Stable)*
...
* [FlameShot](https://github.com/flameshot-org/flameshot) ⭐ 29,897 | 🐛 680 | 🌐 C++ | 📅 2026-05-12 - Screen capture and annotation on Ubuntu.
* [xDoTool](https://github.com/jordansissel/xdotool) ⭐ 3,791 | 🐛 323 | 🌐 C | 📅 2026-03-19 - Click automation on Ubuntu.
...
* [Browsertrix](https://webrecorder.net/browsertrix/) - From [Webrecorder](https://webrecorder.net/), source available at <https://github.com/webrecorder/browsertrix> ⭐ 410 | 🐛 277 | 🌐 TypeScript | 📅 2026-05-14.
